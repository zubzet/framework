...
ZubZet now includes a built-in [**logging system**](../../core-features/logging.md) powered by Monolog.
...
See the [Debug Bar documentation](../../core-features/debug-bar.md) for configuration, internal-query filtering, and how to mark your own models as internal.
...
See the new [Password Handling documentation](../../core-features/password-handling.md) for the full picture, including the verify and hash API and how to add users.
...
If your application calls any of these methods, replace them with the new `logger()` helper. See the [Logging documentation](../../core-features/logging.md) for usage.
...
See the [Logging documentation](../../core-features/logging.md) for all available options.
...
See the [Password Handling documentation](../../core-features/password-handling.md) for the verify and hash API, the scheme model, and how to add users.
