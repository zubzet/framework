...
<?php } function body($opt) { ?> <!-- File body -->	
    ...
    <div class="row">
        <div class="medium-6 small-12 columns">
            <label for="input-start"><?php echo $opt["lang"]("start_date") ?></label>
            <input type="datetime-local" id="input-start">
        </div>

        <div class="medium-6 small-12 columns">
            <label for="input-end"><?php echo $opt["lang"]("end_date") ?></label>
    ...
    <div class="row columns">
        <label><?php echo $opt["lang"]("categories") ?> <span class="hide-for-small-only"><?php echo $opt["lang"]("ctrl_for_multiple") ?></span></label>
        <select id="input-cats" class="input" multiple style="height: 150px;">
        <?php 
    ...
    <button id="button-submit" class="button" disabled><?php echo $opt["lang"]("request") ?></button>
    <a target="_blanc" id="download-csv" class="button"><?php echo $opt["lang"]("download_csv") ?></a>
    <a target="_blanc" id="download-json" class="button"><?php echo $opt["lang"]("download_json") ?></a>
    <a target="_blanc" id="download-txt" class="button"><?php echo $opt["lang"]("download_txt") ?></a>

    <hr>

    <h5><?php echo $opt["lang"]("results") ?></h5>

    <div class="row column">
        <table class="hover scroll">
            <thead>
                <tr>
                    <th><?php echo $opt["lang"]("index") ?></th>
                    <th><?php echo $opt["lang"]("table-date") ?></th>
                    <th><?php echo $opt["lang"]("category") ?></th>
                    <th><?php echo $opt["lang"]("employee") ?></th>
                    <th><?php echo $opt["lang"]("exec_employee") ?></th>
                    <th><?php echo $opt["lang"]("text") ?></th>
                </tr>
            <thead>
    ...
    <script>
        ...
        function updateLink() {
            ...
            link = `log_statistics/ajax/${cats}/${date_start}/${date_end}`;
...
<?php } function getLangArray() {
    ...
    return [
        "de_formal" => [
            ...
            "exec_employee" => "Exec Mitarbeiter",
            "text" => "Text",
            "value" => "Wert",
            "results" => "Ergebnisse (Horizontales Scrollen ist aktiviert)",
            "index" => "ID"
        ], 
        "en" => [
            "table-date" => "Datetime",
            ...
            "text" => "Text",
            "value" => "Value",
            "results" => "Results (Horizontal Scrolling is enabled)",
            "index" => "ID"
        ]
    ];
