...
@section("content")
    <div class="container my-5" style="max-width: 720px">
        <h2 data-test="invitation-heading">{{ __("admin.organization_invitation.title") }}</h2>
        ...
        <div class="card shadow-sm">
            <div class="card-body py-2 px-3">
                <div class="small text-muted mb-3">
                    {{ __("admin.organization_invitation.hint") }}
                </div>

                <dl class="row mb-3">
                    <dt class="col-sm-4">{{ __("admin.organization_invitation.invited_as") }}</dt>
                    <dd class="col-sm-8" data-test="invitation-email">
                        {{ $invite["email"] }}
                    </dd>

                    <dt class="col-sm-4">{{ __("admin.organization_invitation.invited_on") }}</dt>
