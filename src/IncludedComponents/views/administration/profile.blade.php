...
@section("content")
    <div class="mb-3">
        <small class="text-muted text-uppercase">{{ __("admin.profile.title") }}</small>
        ...
        <div class="text-muted small">
            <span class="mr-3">
                ...
                {{ __("admin.profile.member_since") }} <span data-test="profile-created">{{ date("d.m.Y", strtotime($account->getField("created"))) }}</span>
            </span>
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header font-weight-bold">
            <i class="fa fa-fw fa-shield-alt"></i> {{ __("admin.profile.security") }}
        </div>
                ...
                <div class="d-flex justify-content-between align-items-start">
                    <div class="mr-3">
                        ...
                        <small class="text-muted d-block">
                            {{ __("admin.profile.password_hint") }}
                        </small>
                    </div>
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header d-flex justify-content-between align-items-center">
            <span class="font-weight-bold"><i class="fa fa-fw fa-desktop"></i> {{ __("admin.profile.sessions") }}</span>
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-header font-weight-bold">
            <i class="fa fa-fw fa-code"></i> {{ __("admin.profile.api_keys") }}
        </div>
        <div class="card-body">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="z-change-password-title">
                        <i class="fa fa-fw fa-key mr-1"></i> {{ __("admin.profile.change_password") }}
                    </h5>
                ...
                <div class="modal-body">
                    <p class="small text-muted">
                        {{ __("admin.profile.change_password_hint") }}
                    </p>
