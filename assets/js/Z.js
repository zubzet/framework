...
class ZCED { //Create, edit, delete
  ...
  constructor(blueprint = {}) {
    ...
    this.buttonAdd.innerHTML = "+"; //ToDo: make translateable
...
class ZForm {
  ...
  constructor(options = {doReload: true, dom: null}) {
    ...
    this.buttonSubmit.innerHTML = "Submit"; //ToDo: make translateable
  ...
  addField(field) {
    ...
    field.on('change', () => {
      this.hint("alert-danger", "ToDo: Translate: Unsaved Changes");
    });
  }
